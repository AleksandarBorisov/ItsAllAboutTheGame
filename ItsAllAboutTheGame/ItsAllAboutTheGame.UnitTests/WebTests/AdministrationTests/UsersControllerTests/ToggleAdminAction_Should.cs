...
{
    [TestClass]
    public class ToggleAdminAction_Should
    {
        ...
        public void TestInitialize()
        {
            ...
            userServiceMock
                .Setup(user => user.ToggleAdmin(It.IsAny<string>()))
        ...
        public async Task ReturnViewResult_WhenParametersAreCorrect()
        {
            ...
            var result = await controller.ToggleAdmin(userId);
        ...
        public async Task ReturnPartialViewResult_WhenParametersAreCorrect()
        {
            ...
            var result = await controller.ToggleAdmin(userId) as PartialViewResult;
        ...
        public async Task CallsCorrectServices_WhenParametersAreCorrect()
        {
            ...
            //Assert
            userServiceMock.Verify(user => user.ToggleAdmin(It.IsAny<string>()), Times.Once);
        }
        ...
        public async Task ReturnsRedirectToAction_WhenUserIsNull()
        {
            ...
            var result = await controller.ToggleAdmin(null);
