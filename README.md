...
There admins can see all transactions, or filter them by a selected user. and assign admin roles to users All actions in this table are managed by **Transactions Controller** in the coresponding area.
